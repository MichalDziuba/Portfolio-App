...
hTittleLetters.forEach(elm => {
  heroTittle.insertAdjacentHTML(
    'beforeend',
    `<span class="shake__letter">${elm}</span>`,
  );
});
...
heroSection.insertAdjacentHTML(
  'beforeend',
  `<p class="hero__tittle__text"> I am web applications developer. This is my portfolio website. <br>Feel free and take a look around.</p>`,
);
